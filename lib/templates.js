...
Team HR — Apero Technologies Group`
  },
  {
    ...
    body: `Chào {{pronoun}} {{full_name}},

Chỉ còn một ngày nữa thôi, {{pronoun}} sẽ chính thức trở thành một phần của đại gia đình Apero Technologies Group! Chúng tôi vô cùng háo hức được chào đón {{pronoun}} và mong chờ những hành trình thú vị phía trước.

👤 NGƯỜI ĐỒNG HÀNH CÙNG BẠN
Quản lý trực tiếp: {{manager_name}} – {{job_title}}
{{pronoun}} {{manager_name}} sẽ đồng hành cùng {{pronoun}} trong thời gian tới, hỗ trợ trong công việc cũng như giúp {{pronoun}} nhanh chóng hòa nhập với môi trường tại Apero.
...
Chúng tôi rất mong chờ được chào đón {{pronoun}} vào ngày mai.

Nếu {{pronoun}} cần hỗ trợ bất kỳ điều gì thì có thể liên hệ với chúng tôi qua số điện thoại 0867.583.687.

Hẹn gặp {{pronoun}} vào ngày mai!
...
//   email: { type: 'email_sent', key: 'E1' }   → auto-done khi email E1 đã sent
//   order_email: { type: 'order_email', key: 'O1' } → auto-done khi order O1 email_sent
//   order_processed: { type: 'order_processed', key: 'O1' } → auto-done khi order processed
//   all_orders_processed: [O2, O3] → auto-done khi TẤT CẢ orders trong list đã processed
const CHECKLIST_TEMPLATE = [
  // D-7 (5)
  { milestone: 'D-7', task_name: '📧 Gửi email lấy thông tin nhân sự (Form Google)', assignee: 'HR', auto_done_when: { type: 'email_sent', key: 'E1' } },
  { milestone: 'D-7', task_name: '🧰 Order thiết bị làm việc trong group Backoffice', assignee: 'HR + HCNS', auto_done_when: { type: 'email_sent', key: 'E2' } },
  ...
  { milestone: 'D-5', task_name: '📤 Báo PhươngHT bốc dữ liệu Form sang File chính thức', assignee: 'HR → C&B', auto_done_when: { type: 'email_sent', key: 'E5' } },
  { milestone: 'D-5', task_name: '📨 Gửi email order cấp email công ty cho MyNTH', assignee: 'HR → IT', auto_done_when: { type: 'email_sent', key: 'E3' } },
  { milestone: 'D-5', task_name: '🔐 Gửi email order cấp tài khoản Confluence cho HùngNX', assignee: 'HR → IT', auto_done_when: { type: 'email_sent', key: 'E4' } },
  { milestone: 'D-5', task_name: '💼 Gửi email order tài khoản MISA + Username cho PhươngHT', assignee: 'HR → C&B', auto_done_when: { type: 'email_sent', key: 'E5' } },
  // D-3 (3)
  { milestone: 'D-3', task_name: '💌 Gửi email chào mừng + giới thiệu quản lý cho ứng viên', assignee: 'HR', auto_done_when: { type: 'email_sent', key: 'E6' } },
  ...
  // D-1 (4)
  { milestone: 'D-1', task_name: '🌟 Gửi email Welcome cho ứng viên', assignee: 'HR', auto_done_when: { type: 'email_sent', key: 'E7' } },
  ...
  { milestone: 'D0', task_name: '📧 Gửi mail cấp tài khoản nội bộ (Gmail, Confluence, Discord, FB)', assignee: 'HR + IT', auto_done_when: { type: 'email_sent', key: 'E8' } },
