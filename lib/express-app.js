...
// ═══════════════════════════════════════════════════════════════════
// AUTH — public endpoints (BEFORE middleware bảo vệ)
// ═══════════════════════════════════════════════════════════════════
// Frontend gọi đầu tiên để biết auth config + check session
app.get('/api/auth/config', (req, res) => {
  res.json({
    enabled: auth.hasAuthConfig(),
    google_client_id: auth.getClientId(),
    allowed_domains: auth.getAllowedDomains()
  });
});

// Frontend check ai đang đăng nhập (hoặc null)
