...
// Email ↔ Order mapping for cascade sync (Spec UX v1.1 — 8 mốc)
// M2 = Order thiết bị (HCNS) → O1
// M3 = Cấp tài khoản (IT — consolidated email/Confluence/MISA) → O2, O3, O4
const EMAIL_TO_ORDER_KEYS = { M2: ['O1'], M3: ['O2', 'O3', 'O4'] };
const ORDER_TO_EMAIL_KEY = { O1: 'M2', O2: 'M3', O3: 'M3', O4: 'M3' };
