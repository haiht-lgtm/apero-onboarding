...
function signatureHtml() {
  ...
  <tr>
    <td style="vertical-align:middle;padding-right:22px">
      <div style="width:130px;height:74px;background:#111111;border-radius:6px;color:#ffffff;font-weight:800;font-size:24px;letter-spacing:2px;text-align:center;line-height:74px;font-family:Arial,sans-serif">APERO</div>
    </td>
