...
const SIGNATURE = {
  ...
  logoUrl: 'https://apero.vn/wp-content/uploads/2025/01/logo-black-1.png'
};
...
function signatureHtml() {
  ...
  <tr>
    <td style="vertical-align:middle;padding-right:22px">
      <img src="${escapeHtml(SIGNATURE.logoUrl)}" alt="APERO" width="150" style="display:block;width:150px;height:auto;border:0;outline:none"/>
    </td>
